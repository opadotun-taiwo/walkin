  ...
  return (
    <div className="bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="font-bold text-3xl mb-2 title">Up to 40% off for haircut at frank cutz<span className='inline-block px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2'> No 30 oniru off water cooportion, VI <GoLocation className='text-[#89E101]' /></span>
            ...
            <p className="text-gray-700 text-base">
              <span className='line-through text-2xl font-bold'>#1500</span> to <span className='text-2xl font-bold price'>800</span> <span className="inline-block border border-[#89E101] rounded px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">40% off</span>
            </p>
        <div className="flex items-center justify-center h-24">
          <p className="text-2xl font-bold text-green-900 time">{getFormattedTime()}</p>
        </div>
